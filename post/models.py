...
class Post(models.Model):
    ...
    description = RichTextField(null=True, blank=True,     config_name="default", external_plugin_resources=[(    'youtube', '/static/shareledge/ckeditor-plugins/youtube/youtube/', 'plugin.js',    )])
