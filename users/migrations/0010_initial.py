...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('users', '0009_remove_doctor_groups_remove_doctor_user_permissions_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Administrator'), ('doctor', 'Doctor'), ('user', 'User')], max_length=15)),
